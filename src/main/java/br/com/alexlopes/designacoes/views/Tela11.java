...
public class Tela11 extends javax.swing.JFrame {
    ...
    private void preencherSalaAB() {
        ...
        if (cDiscurso.isSelected() && txtParte3B.getText().isEmpty()) {
            ...
            txtParte3B.setText(discursoB.getNome() + " " + discursoB.getSobrenome());                  //Iniciando conversas       Fazendo discipulos      Cultivando o interesse      Explicando suas crenças
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela11.class
