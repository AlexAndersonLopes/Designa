...
public class Qual extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecione qual é a parte número ");

        jLabel2.setBackground(new java.awt.Color(204, 204, 204));
        jLabel2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Iniciando conversas");
        ...
        jLabel3.setText("Cultivando o interesse");
        ...
        jLabel4.setText("Explicando suas crenças");
        ...
        jLabel5.setText("Fazendo discipulos");
        ...
        jLabel7.setText("Consideração da Brocura");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        a = "Iniciando conversas";
        Janela.sub.altParteTipo(a);
        this.dispose();
    }//GEN-LAST:event_jLabel2MouseClicked

    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        a = "Cultivando o interesse";
        Janela.sub.altParteTipo(a);
        this.dispose();
    }//GEN-LAST:event_jLabel3MouseClicked

    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        a = "Explicando suas crenças";
        Janela.sub.altParteTipo(a);
        this.dispose();
    }//GEN-LAST:event_jLabel4MouseClicked

    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        a = "Fazendo discipulos";
        Janela.sub.altParteTipo(a);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Qual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Qual dialog = new Qual(new javax.swing.JFrame(), true);
